-- ChatFlow360 V16.26 - WhatsApp real + contexto American Style más humano
-- Seguro: solo CREATE/ALTER IF NOT EXISTS / policies permisivas. No borra datos.
...
-- Config editable por admin / empresa.
...
-- Policies permisivas para el entorno SaaS actual con panel propio.
